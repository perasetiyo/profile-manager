...
var KirimoApi = function () {
    function KirimoApi(routes) {
        _classCallCheck(this, KirimoApi);
...
exports.default = KirimoApi;


var boot = function boot(routes, port, fn) {
    var api = new KirimoApi(routes);
    api.listen(port, fn);
};

exports.boot = boot;
//# sourceMappingURL=kirimoapi.js.map
